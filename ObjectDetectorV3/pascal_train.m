...
try 
  ...
  model = train(cls, model, pos, neg(1:min(end,200)), 0, 0, 2, 2, 2^28, true, 0.7);
...
try 
  ...
  model = train(cls, model, pos, neg(1:min(end,200)), 0, 0, 1, 4, 2^30, true, 0.7);
  model = train(cls, model, pos, neg(1:min(end,200)), 0, 0, 6, 2, 2^30, true, 0.7, true);
